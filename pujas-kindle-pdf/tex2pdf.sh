...
cat puja-kindle-template.tex ../pujas/$fname | sed 's@pujas/@../pujas/@;s@purvanga@../purvanga@;s@../stotra@../../stotra@;s@../appendices@../../appendices@;s@../veda@../../veda@;s@../namavali@../../namavali@;$a\\\\end{document}' > $jobname-vidhanam.tex
