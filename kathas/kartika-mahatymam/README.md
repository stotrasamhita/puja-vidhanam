# kathas/kartika-mahatymam/

From the Skanda Purāṇa's Vaiṣṇava-khaṇḍa:

- `KarttikaMasaMahatmyam.tex` — the full Kārtika-māsa-māhātmya, 36 chapters (अध्याय) of Sūta's narration to the ṛṣis on the glory of the month of Kārtika. This is the typeset file assembled from the working material in `src/` — see that folder's README.
